    ...
    <div className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <nav className={styles.breadcrumb}>
          <Link to="/hub" className={styles.breadcrumbLink}>Home</Link>
          <span className={styles.breadcrumbSep}>/</span>
          <Link to="/explorar" className={styles.breadcrumbLink}>Produtos</Link>
          <span className={styles.breadcrumbSep}>/</span>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.infoCol}>
            ...
            <div className={styles.providerRow}>
              <span className={styles.providerName}>{product.provider_name}</span>
            ...
            <div className={styles.ratingRow}>
              ...
              <span className={styles.ratingCount}>({rating.count} avaliações)</span>
            </div>

            <div className={styles.priceCard}>
              <span className={styles.priceLabel}>Preço</span>
              <span className={styles.priceValue}>R$ {product.price.toFixed(2)}</span>
            </div>
            ...
            <p className={styles.btnHint}>Orçamento sem compromisso • Resposta rápida</p>
