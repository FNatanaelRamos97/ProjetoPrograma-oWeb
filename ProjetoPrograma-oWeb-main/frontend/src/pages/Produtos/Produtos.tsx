...
function getRating(id: number) {
  return { stars: Math.min(4 + (id % 2), 5), count: 10 + id * 3 }
}
      ...
      <div className={styles.container}>
        ...
        <div className={styles.topSection}>
          <div className={styles.topLeft}>
            ...
            <p className={styles.pageSub}>Encontre o serviço ideal para você.</p>
          </div>
                ...
                >
                  ...
                  <p className={styles.cardDesc}>
                    {item.description.length > 60
                      ...
                      : item.description || 'Serviço profissional de qualidade.'}
                  </p>
                  ...
                  <div className={styles.cardFooter}>
                    <div className={styles.cardProvider}>
                      ...
                      <div className={styles.providerInfo}>
                        <span className={styles.providerName}>{item.provider_name}</span>
