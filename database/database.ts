...
export async function listProviders(): Promise<{ id: number; name: string; profileImageUrl: string | null }[]> {
...
export async function listFeaturedProviders(): Promise<FeaturedProvider[]> {
  const response = await fetch(`${API_URL}/users/providers/featured`);
  if (!response.ok) return [];
  return response.json();
}
...
export async function createStripeCheckoutSession(
  appointmentId: number,
  token: string,
): Promise<{ checkoutUrl: string; sessionId: string } | { error: string } | null> {
  ...
  if (!response.ok) {
    try {
      ...
      return { error: body.message ?? "Erro ao processar pagamento." };
    } catch {
...
export async function createMercadoPagoCheckoutSession(
  ...
  const response = await fetch(`${API_URL}/payments/mercadopago/checkout-session`, {
    method: "POST",
    headers: getJsonAuthHeaders(token),
    body: JSON.stringify({ appointmentId }),
  });
  ...
  if (!response.ok) {
    try {
      const body = await response.json();
      return { error: body.message ?? "Erro ao processar pagamento com Mercado Pago." };
    } catch {
      return { error: "Erro ao processar pagamento com Mercado Pago." };
    }
  }
...
export async function createAbacatePayCheckoutSession(
  appointmentId: number,
  token: string,
): Promise<{ checkoutUrl: string; sessionId: string } | { error: string } | null> {
  const response = await fetch(`${API_URL}/payments/abacatepay/checkout-session`, {
    method: "POST",
    headers: getJsonAuthHeaders(token),
    body: JSON.stringify({ appointmentId }),
  });
  ...
  if (!response.ok) {
    try {
      const body = await response.json();
      return { error: body.message ?? "Erro ao processar pagamento com Abacate Pay." };
    } catch {
      return { error: "Erro ao processar pagamento com Abacate Pay." };
    }
  }
...
export async function getMyAvailabilitySchedule(
  token: string,
): Promise<AvailabilityScheduleEntry[]> {
  const response = await fetch(`${API_URL}/provider-availability/me`, {
    headers: getAuthHeaders(token),
  });
...
export async function updateMyAvailabilitySchedule(
...
export async function getMyAvailabilityOverrides(
  ...
  const response = await fetch(
    `${API_URL}/provider-availability/overrides?year=${year}&month=${month}`,
    { headers: getAuthHeaders(token) },
  );
...
export async function saveAvailabilityOverride(
  ...
  const response = await fetch(`${API_URL}/provider-availability/overrides`, {
    method: "POST",
    headers: getJsonAuthHeaders(token),
    body: JSON.stringify(data),
  });
...
export async function deleteAvailabilityOverride(
  ...
  const response = await fetch(
    `${API_URL}/provider-availability/overrides/${id}`,
    {
      method: "DELETE",
      headers: getAuthHeaders(token),
    },
...
export async function getMyBlockedSlots(
  ...
  const response = await fetch(`${API_URL}/provider-availability/blocked-slots`, {
    headers: getAuthHeaders(token),
  });
...
export async function blockTimeSlot(
  ...
  const response = await fetch(
    `${API_URL}/provider-availability/blocked-slots`,
    {
      method: "POST",
      headers: getJsonAuthHeaders(token),
      body: JSON.stringify(data),
...
export async function unblockTimeSlot(
  ...
  const response = await fetch(
    `${API_URL}/provider-availability/blocked-slots/${id}`,
    {
      method: "DELETE",
      headers: getAuthHeaders(token),
    },
...
export async function getMyCancellationRequests(
  ...
  const response = await fetch(`${API_URL}/cancellation-requests/my`, {
    headers: getAuthHeaders(token),
  });
...
export async function getAllCancellationRequests(
  ...
  const response = await fetch(`${API_URL}/cancellation-requests/admin`, {
    headers: getAuthHeaders(token),
  });
...
export async function approveCancellationRequest(
  ...
  const response = await fetch(
    `${API_URL}/cancellation-requests/${id}/approve`,
    {
      method: "PATCH",
      headers: getJsonAuthHeaders(token),
      body: JSON.stringify({ adminNote }),
...
export async function rejectCancellationRequest(
  ...
  const response = await fetch(
    `${API_URL}/cancellation-requests/${id}/reject`,
    {
      method: "PATCH",
      headers: getJsonAuthHeaders(token),
      body: JSON.stringify({ adminNote }),
