...
import CancelamentosSection from "./sections/CancelamentosSection";
...
const sectionHeaders: Record<string, { title: string; subtitle: string }> = {
  ...
  cancelamentos: {
    title: "Cancelamentos 🛑",
    subtitle: "Analise as solicitações de cancelamento de pedidos.",
  },
};
...
export default function Admin() {
  ...
  useEffect(() => {
    async function loadData() {
      if (!token) return;
      setLoading(true);
      const [d, u, s, r, sl, ss, wr, rv] = await Promise.all([
